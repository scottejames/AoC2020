...
public enum HexDirection {
    ...
    public static HexDirection get(String code) {

        return Arrays.stream(values()).filter(e -> e.code.equals(code)).findAny().get();
    }
    public static HexDirection getByDir(char code) {
